                            ...
                            <form onSubmit={this.handleSubmit}>
                                ...
                                <div className="field">
                                    <label className="label">How can politics affect people in our community? Why is political awareness important?</label>
                                        <div className="control">
                                        <textarea value={this.state.politicsimportant} required onChange={this.handleChanges} name="politicsimportant" className="textarea" placeholder="Politics are important because..."></textarea>
                                        </div>
                                </div>
                                ...
                                <div className="field">
                                    <label className="label">Briefly explain why you are fit for the role. What have you done in the past in terms of community involvement, volunteering, and/or leadership?</label>
                                        <div className="control">
                                        <textarea value={this.state.fitforrole} required onChange={this.handleChanges} name="fitforrole" className="textarea" placeholder="I am well-suited for this position because I..."></textarea>
                                        </div>
                                </div>
                                ...
                                <div className="field">
                                    <label className="label">(Optional) What are your ideas for Unipolitics? What are some projects that you believe could help extend political awareness and neutrality in our community?</label>
                                        <div className="control">
                                        <textarea value={this.state.ideas} onChange={this.handleChanges} name="ideas" className="textarea" placeholder="A great project would be..."></textarea>
                                        </div>
                                </div>
